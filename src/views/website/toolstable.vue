		...
		<div class="container">
			...
			<div class="handle-box">
				<el-button type="primary" :icon="Plus" @click="add"
					v-if="buttonVisiableMap.get('toolsWebsiteAdd')">新增</el-button>
				<el-button type="primary" :icon="Edit" @click="handleEdit"
					v-if="buttonVisiableMap.get('toolsWebsiteUpdate')">编辑</el-button>
				<el-button type="danger" :icon="Delete" @click="handleDelete"
					v-if="buttonVisiableMap.get('toolsWebsiteDelete')">删除</el-button>
			</div>
...
let buttonVisiableMap = getControlVisiableMap(['toolsWebsiteAdd', 'toolsWebsiteUpdate', 'toolsWebsiteDelete'])
interface TableItem {
	id: number;
	websiteUrl: string;
	websiteName: string;
