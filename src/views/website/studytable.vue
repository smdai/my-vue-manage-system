		...
		<div class="container">
			...
			<div class="handle-box">
				<el-button type="primary" :icon="Plus" @click="add"
					v-if="buttonVisiableMap.get('studyWebsiteAdd')">新增</el-button>
				<el-button type="primary" :icon="Edit" @click="handleEdit"
					v-if="buttonVisiableMap.get('studyWebsiteUpdate')">编辑</el-button>
				<el-button type="danger" :icon="Delete" @click="handleDelete"
					v-if="buttonVisiableMap.get('studyWebsiteDelete')">删除</el-button>
			</div>
...
let buttonVisiableMap = getControlVisiableMap(['studyWebsiteAdd', 'studyWebsiteUpdate', 'studyWebsiteDelete'])
interface TableItem {
	id: number;
	websiteUrl: string;
	websiteName: string;
