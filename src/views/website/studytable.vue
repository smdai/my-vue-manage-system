<template>
	<div>
		<div class="container">
			...
			<div class="handle-box">
				<BztcButton type="primary" :icon="Plus" controlKey="studyWebsiteAdd" @click="add" buttonName="新增" />
				<BztcButton type="primary" :icon="Edit" controlKey="studyWebsiteUpdate" @click="handleEdit" buttonName="编辑" />
				<BztcButton type="danger" :icon="Delete" controlKey="studyWebsiteDelete" @click="handleDelete" buttonName="删除" />
				<BztcButton type="primary" :icon="Grid" controlKey="studyGenerateQrCode" @click="initQrCode"
					buttonName="生成二维码" />
			</div>
